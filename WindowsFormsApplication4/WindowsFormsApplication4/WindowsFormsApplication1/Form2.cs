...
namespace WindowsFormsApplication1
{
    public partial class Form2 : Form
    {
        ...
        private void maToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            double x=(double) (f.Count())/(double)Program.MyList.Count*100;
        ...
        private void getRangToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void revarceToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void asnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Student.flag = 1;
            Program.MyList.Sort();
            dataGridView1.DataSource = null;
        ...
        private void dasnToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Student.flag = 0;
            Program.MyList.Sort();
            dataGridView1.DataSource = null;
